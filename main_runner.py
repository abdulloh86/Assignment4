...
def format_results(results):
    ...
    # Hitung persentase perbedaan dengan pengamanan terhadap division by zero
    if results['a_star_time'] > 0:
    ...
    elif results['gbfs_time'] > 0:
        print("\nPersentase perbedaan waktu: A* terlalu cepat untuk diukur")
    else:
        print("\nKedua algoritma terlalu cepat untuk diukur perbedaan waktunya")
    
    if results['a_star_nodes'] > 0:
